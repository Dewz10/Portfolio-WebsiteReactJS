                    ...
                    <SwiperSlide key={index}>
                        <div className='flex flex-col lg:flex-row gap-12 lgg:gap-32'>
                            ...
                            <div className='flex flex-col max-w-3xl'>
                                ...
                                <div>
                                    <br/><br/>
                                    <a href={item.href} class="text-white bg-accent hover:bg-accent-hover focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">More information</a>
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
